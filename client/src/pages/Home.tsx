    ...
    const fetchSliderImage = async () => {
        try {
            const response = await api.get(
                "/admin/sliderImage/allHomeSliderImage"
            );
                ...
                <div className="mt-32 max-w-7xl mx-auto">
                    <div className="max-w-5xl mx-auto text-center relative px-4 sm:px-10 mt-16">
                        ...
                        <p className="text-base text-gray-800">
                            From grand weddings to corporate events, we make
                            every occasion extraordinary.
                            <br /> Plan Your Event Today – Let’s Make It
                            Unforgettable!
                        </p>
                    </div>
                ...
                <div ref={aboutRef} className="mt-32 rounded-md px-4 py-12">
                    <div className="grid md:grid-cols-2 justify-center items-center gap-12 max-w-7xl mx-auto">
                        ...
                        <div className="max-md:text-center">
                            ...
                            <p className="text-gray-800">
                                We don’t just plan events—we craft unforgettable
                                experiences. Our approach is rooted in
                                creativity, precision, and a deep understanding
                                of your vision. From concept to execution, we
                                focus on every detail, ensuring seamless
                                coordination and flawless delivery. What sets us
                                apart is our personalized service, innovative
                                ideas, and commitment to excellence. Whether
                                it's an intimate gathering or a grand
                                celebration, we bring passion, professionalism,
                                and a touch of magic to make your event truly
                                extraordinary.
                            </p>
                            <button
                                type="button"
                ...
                <div className="mt-32 rounded-md px-4 py-12">
                    <div className="grid md:grid-cols-2 justify-center items-center gap-12 max-w-7xl mx-auto">
                        <div className="max-md:text-center">
                            ...
                            <p className="text-gray-800">
                                We specialize in seamless event planning and
                                management, turning your ideas into
                                unforgettable experiences. From corporate
                                gatherings to grand celebrations, our expert
                                team handles everything—venue selection, decor,
                                entertainment, logistics, and more. Let us make
                                your event stress-free and spectacular!
                            </p>
                            <button
                                type="button"
                                className="px-6 py-3.5 rounded-md text-gray-100 bg-blue-700 hover:bg-blue-800 transition-all mt-10 cursor-pointer"
                    ...
                    <div className="mt-16 relative w-full max-w-4xl mx-auto overflow-hidden rounded-lg">
                        <div className="flex items-center justify-center">
                            ...
                            <motion.div
                                ...
                                style={{
                                    width: `${
                                        (images.length * 100) / itemsPerView
                                    }%`,
                                }}
                            >
                                {images.map((img, i) => (
                        ...
                        <div className="flex justify-center items-center mt-12">
                            <button
                                ...
                                onClick={() =>
                                    (window.location.href = "/ourgallery")
                                }
                            >
                                View Entire Gallery
                            </button>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 max-md:justify-center text-center mt-16">
                            ...
                            <div className="flex flex-col items-center">
                                <div className="mt-4">
                                    <p className="text-gray-800">
                                        ...
                                        guest’s goodbye, The Rox Event
                                        Organisers impressed us with their
                                        unmatched attention to detail. No
                                        request was too big or too small — every
                                        flower arrangement, lighting choice, and
                                        schedule was flawlessly executed. They
                                        truly care about making your event
                                        perfect.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="flex flex-col items-center">
                                <div className="mt-4">
                                    <p className="text-gray-800">
                                        Beyond Our Wildest Dreams The Rox Event
                                        Organisers didn’t just plan our wedding
                                        — they crafted an unforgettable
                                        experience. Every detail, from the
                                        breathtaking décor to the seamless
                                        coordination, was beyond what we
                                        imagined. Their passion and creativity
                                        turned our special day into pure magic.
                                        We’re still receiving compliments from
                                        our guests! Truly a dream team.
                                    </p>
                                </div>
                            </div>
                            <div className="mt-6">
                        ...
                        <div>
                            <div className="flex flex-col items-center">
                                <div className="mt-4">
                                    <p className="text-gray-800">
                                        Flawless Corporate Event Execution We
                                        entrusted The Rox with our annual
                                        corporate gala, and they delivered
                                        perfection. Their professionalism,
                                        strategic planning, and eye for detail
                                        ensured the event ran like clockwork.
                                        The ambiance, entertainment, and
                                        hospitality were world-class. Looking
                        ...
                        <div>
                            <div className="flex flex-col items-center">
                                <div className="mt-4">
                                    <p className="text-gray-800">
                                        A Masterpiece of Elegance and Charm
                                        "What sets The Rox apart is their
                                        ability to transform ideas into stunning
                                        realities. Our anniversary celebration
                                        was a masterpiece — elegant yet
                                        personal, grand yet intimate. They
                                        listened to our vision and elevated it
                                        to a level we didn’t think possible.
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-16">
                        ...
                        <div className="text-center p-6">
                            ...
                            <p className="text-gray-600">
                                33 Kalani Nagar, Airport Road, Behind Bank of
                                Baroda, Indore, Madhya Pradesh
                            </p>
                        </div>
                    </div>
                </div>
